...
class PengajuanSktm extends StatefulWidget {
  const PengajuanSktm({Key key}) : super(key: key);

  @override
  State<PengajuanSktm> createState() => _PengajuanSktmState();
}

class _PengajuanSktmState extends State<PengajuanSktm> {
  @override
              ...
              ListTile(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => const SKTM()));
                  },
                  leading: Container(
                    width: 40,
                    height: 40,
