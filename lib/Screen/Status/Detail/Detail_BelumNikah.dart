...
class DetailBelumNikah extends StatefulWidget {
  ...
  int index;
  DetailBelumNikah({this.list, this.index});

  @override
  State<DetailBelumNikah> createState() => _DetailBelumNikahState();
}

class _DetailBelumNikahState extends State<DetailBelumNikah> {
