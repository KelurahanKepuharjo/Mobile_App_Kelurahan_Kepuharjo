...
class _DetailKematianState extends State<DetailKematian> {
  ...
  void pembatalanSurat() async {
    try {
      var url = Uri.parse(ApiConnect.pembatalanSuratKematian);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            getDetailSurat(
                "Nama Almarhum : ${widget.list[widget.index].namaAlmarhum}"),
            getDetailSurat(
                "Saksi Kematian : ${widget.list[widget.index].saksiKematian}"),
            ...
            getDetailSurat(
                "Nik Almarhum : ${widget.list[widget.index].nikAlmarhum}"),
            getDetailSurat(
                "Penyebab Kematian : ${widget.list[widget.index].penyebabKematian}"),
