...
class DetailBerkelakuanBaik extends StatefulWidget {
  List<cBerkelakuanBaik> list;
  int index;
  DetailBerkelakuanBaik({this.list, this.index});

  @override
  State<DetailBerkelakuanBaik> createState() => _DetailBerkelakuanBaikState();
}

class _DetailBerkelakuanBaikState extends State<DetailBerkelakuanBaik> {
  ...
  void pembatalanSurat() async {
    if (widget.list[widget.index].statusSurat == "Diajukan") {
      try {
        var url = Uri.parse(ApiConnect.pembatalanBerkelakuanBaik);
