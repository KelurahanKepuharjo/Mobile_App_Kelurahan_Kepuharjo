...
class BerkelakuanBaikSelesai extends StatefulWidget {
  ...
  @override
  State<BerkelakuanBaikSelesai> createState() => _BerkelakuanBaikSelesaiState();
}

class _BerkelakuanBaikSelesaiState extends State<BerkelakuanBaikSelesai> {
  ...
  void initState() {
    ...
    super.initState();
    listdata = serviceApi.getBerkelakuanBaikSelesai();
  }
  ...
  void openPdf(BuildContext context, File file, String url) =>
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => PdfBerkelakuanBaik(
            file: file,
            url: url,
          ),
        ),
